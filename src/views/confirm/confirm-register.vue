    ...
    <v-card elevation="0" outlined class="mt-5">
      <v-col class="text-center" cols="12">
        ...
        <v-row>
          <v-col cols="12" class="mx-auto">
            <v-card-text class="font-flower text-left">
              Merci de procéder à la <b>vérification de votre adresse e-mail</b>, 
              en cliquant sur le lien de validation que vous avez reçu par e-mail (pensez à vérifier vos spams).
              <br><br>
        ...
        <v-toolbar color="transparent" elevation="0">
          <v-spacer/>
          <v-btn class="my-2 mx-auto" elevation="0"

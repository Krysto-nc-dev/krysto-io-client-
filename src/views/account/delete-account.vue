    ...
    <v-col cols="12" sm="9" md="6" lg="5" 
      ...
      <v-col cols="12">
        ...
        <v-card-text>
          ...
          La monnaie présente sur vos comptes sera définitivement perdue.<br><br>
          <b>Vous ne pourrez pas réutiliser la même adresse e-mail pour créer un nouveau compte.</b>
          <br><br>
          <span class="red--text">
            Vous serez automatiquement déconnecté de la plateforme.
          </span>
          <br><br>
        </v-card-text>
        ...
        <v-form @submit.prevent="saveNewPassword">
          ...
          <v-toolbar dense elevation="0" color="transparent">
            <v-spacer/>
            <v-btn elevation="0" to="/profil" class="mr-2"
                  dark  :disabled="password == ''">
              Annuler
            </v-btn>

            <v-btn elevation="0" color="red" @click="deleteAccount" :loading="loading"
                  dark  :disabled="password == ''">
